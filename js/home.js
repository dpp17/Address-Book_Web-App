...
const createInnerHtml = () => {
    const headerHtml = "<th>Fullname</th><th>Profession</th><th>Gender</th><th>EmailID</th><th>Address</th><th>City</th><th>State</th><th>Zip Code</th><th>Phone Number</th><th>Action</th>"
    ...
    <tr>
        ...
        <td>
            <img id="${addressBook.id}" onclick="remove(this)" alt="delete" title="Delete" src="../assets/trassh.png" width=20px>
            <img id="${addressBook.id}" alt="edit" onclick="update(this)" title="Edit" src="../assets/pencil.png" width=20px>
        </td>
    </tr>
    `;
        document.querySelector('#display').innerHTML = innerHtml;
